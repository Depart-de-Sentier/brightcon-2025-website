  ...
  <div class="container">
    <section>
      <h1 id="contributor-covenant-code-of-conduct">
        Brightcon follows the Contributor Covenant Code of Conduct
      </h1>
      <p>
        The organizing committee of Brightcon adopts the Contributor Covenant
        Code of Conduct to make sure the event is a safe place.
      </p>
      ...
      <p>
        ...
        <a href="mailto:tomas.navarrete@list.lu">Tomás NAVARRETE GUTIÉRREZ</a>.
